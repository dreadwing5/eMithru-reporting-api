...
class ExcelReportGenerator:
    ...
    def send_email_report(self, hod_email: str, hod_name: str, smtp_server: str, smtp_port: int, smtp_username: str,
                          smtp_password: str):
        current_date = datetime.datetime.now()
        year = current_date.year
        month = current_date.strftime("%B")

        subject = f"Monthly Interaction Report for {month} {year} 📊"

        body = f"Dear {hod_name},\n\nPlease find attached the monthly interaction report for the month of {month} {year}. " \
        ...
        try:
            ...
            smtp_server.sendmail(smtp_username, hod_email, msg.as_string())
            smtp_server.quit()
